                                    ...
                                    <div class="mt-1.5">
                                        <div class="flex items-center gap-2">
                                            <input type="text" x-model="nameDraft" maxlength="100" autofocus
                                                   ...
                                                   class="w-full max-w-[180px] rounded-lg border border-gold-300/70 px-2.5 py-1.5 text-base sm:text-sm text-maroon-800 focus:outline-none focus:ring-2 focus:ring-gold-400 focus:border-gold-400 transition">
                ...
                <div x-show="tab === 'addresses'" x-cloak
                    ...
                    <div x-show="showAddForm" x-cloak x-transition class="bg-white rounded-2xl border border-gold-200/60 shadow-sm p-5 mb-4">
                        ...
                        <input type="text" x-model="form.label" placeholder="e.g. Home, Work" maxlength="40"
                               class="w-full rounded-lg border border-gold-300/70 px-3 py-2 text-base sm:text-sm text-maroon-800 placeholder-maroon-400/50 focus:outline-none focus:ring-2 focus:ring-gold-400 focus:border-gold-400 transition">
                        ...
                        <textarea x-model="form.address_line" rows="3" maxlength="500"
                                  ...
                                  class="w-full rounded-lg border border-gold-300/70 px-3 py-2 text-base sm:text-sm text-maroon-800 placeholder-maroon-400/50 focus:outline-none focus:ring-2 focus:ring-gold-400 focus:border-gold-400 transition"></textarea>
