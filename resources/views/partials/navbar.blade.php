...
<header x-data="{
    ...
    @php
        ...
        $menuLinks = [
            ...
            ['href' => '#range', 'label' => __('Our Kitchen'), 'paths' => ['M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.048 8.287 8.287 0 0 0 9 9.6a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 0 3 2.48Z', 'M12 18a3.75 3.75 0 0 0 .495-7.468 5.99 5.99 0 0 0-1.925 3.547 5.975 5.975 0 0 1-2.133-1.001A3.75 3.75 0 0 0 12 18Z']],
    ...
    <div x-show="open" x-cloak
        ...
        <div class="sticky top-0 z-10 relative overflow-hidden bg-gradient-to-br from-maroon-800 via-maroon-700 to-maroon-600 px-5 py-5 flex items-center justify-between shrink-0">
            ...
            <div class="relative">
                ...
                <p class="text-cream/80 text-xs mt-0.5">{{ __('Sweet Shop') }} · Makhanbhog</p>
            </div>
