...
<h2>4. Product Information, Pricing &amp; Images</h2>
<p>We make reasonable efforts to display accurate product descriptions, weights/quantities, and prices. Loose items (such as dal, rice, or other bulk groceries) are priced per portion (e.g. 200g, 500g, 1kg) as shown on the product page; packaged items are priced per piece/unit as sold. Prices are inclusive of applicable taxes unless stated otherwise and may change without prior notice, though a price change will never affect an order already placed and confirmed.</p>
<p><b>Product images are for reference only.</b> We use manufacturer or representative images wherever possible, but actual packaging design, branding, label, colour, or weight/size shown may differ from the image displayed, due to manufacturer packaging updates, natural variation in loose or bulk items, or photography limitations. The product title, weight/quantity, and description shown on the page — not the photo alone — are what you are actually ordering. If what arrives is materially different from the description (not just the photo), please see our <a href="/refund-policy">Refund &amp; Cancellation Policy</a>.</p>
...
<h2>6. Payments</h2>
<p>We currently accept Cash on Delivery (COD). Online prepayment (via cards, UPI, netbanking, or wallets through Razorpay) may also be offered from time to time and, when available, will be clearly presented as a payment option at checkout. Online payments, where offered, are processed securely by Razorpay; we do not store your card, UPI, or bank credentials. If you have previously not accepted a Cash on Delivery order, we may require your next order(s) to be prepaid online before COD is offered to you again — this is shown clearly at checkout when it applies.</p>

<h2>7. Delivery</h2>
<p>We currently deliver within a defined area around our Siswa Bazar location; if your delivery address falls outside this area, the Platform will inform you at checkout and the order cannot be placed. Estimated delivery times shown on your order (typically around 20 minutes for nearby addresses) are our best estimate, not a guaranteed delivery window, and may be affected by weather, traffic, order volume, or circumstances beyond our control. Please ensure someone is available to receive the order at the address and time provided.</p>

<h2>8. Cancellation, Returns &amp; Refunds</h2>
<p>You may cancel an order yourself within a short window shown on your order tracking page, before we begin preparing it; once that window has passed or the order is out for delivery, please contact us directly and we will do our best to accommodate reasonable requests. Most of our products are packaged and sealed by the manufacturer; for loose/bulk items, please check the item at the time of delivery. Full details on cancelling, returning, or getting a refund are in our <a href="/refund-policy">Refund &amp; Cancellation Policy</a>, which forms part of these Terms.</p>
...
<h2>10. Account Access for Customer Support</h2>
<p>To help resolve an order or account issue, our authorized support staff may — only where genuinely needed, and never to place orders or make changes on your behalf without reason — temporarily view your account exactly as you would see it. This access is fully logged (who accessed it, when, and for how long), shown on-screen for the entire duration it happens, and automatically ends after a short period of inactivity. Full details are in our <a href="/privacy">Privacy Policy</a>.</p>
...
<ul>
<li>Phone: +91 95987 54455</li>
<li>WhatsApp: <a href="https://wa.me/919598754455">wa.me/919598754455</a></li>
<li>Address: Roadways Bus Stand, Nichlaul Road, Siswa Bazar, Maharajganj, UP 273163</li>
<li>Hours: 8:00 AM – 9:00 PM, open daily</li>
</ul>
HTML;
    }
    ...
    private function privacy(): string
    {
        return <<<'HTML'
<h2>1. Introduction</h2>
<p>This Privacy Policy explains how Shri Vinayak Family Shop ("we", "us") collects, uses, stores, and protects your personal information when you use our website and ordering platform (the "Platform"). It should be read together with our <a href="/terms">Terms &amp; Conditions</a>.</p>
...
<p>Where online payment is offered, it is processed by Razorpay, a licensed and regulated payment gateway. We do not collect or store your full card number, UPI PIN, or net-banking credentials — these are handled directly by Razorpay under its own security and privacy standards. We retain only the payment status, method, and transaction reference needed to confirm and, where necessary, refund your order.</p>

<h2>6. Account Access by Our Support Team</h2>
<p>To help resolve an order or account problem you've raised, an authorized administrator can temporarily sign in and view your account exactly as you would — for example, to see what you're seeing when troubleshooting an issue with your cart, order, or profile. This access is a deliberate, logged support tool, not routine monitoring, and works as follows:</p>
<ul>
<li>Every time it happens, we record who accessed the account, when, from what device/IP address, and for how long — this record is permanent and is never edited or deleted.</li>
<li>It is clearly shown on-screen for the entire time it's active, so it is never done invisibly.</li>
<li>It automatically ends after a short period of inactivity, and does not persist beyond that browser session.</li>
<li>It is used only for genuine support purposes — not to place orders, change your details, or take any action on your behalf without a clear reason tied to helping you.</li>
</ul>
<p>You're welcome to ask our support team whether your account has ever been accessed this way and why.</p>

<h2>7. Sharing of Information</h2>
<p>We share your delivery details (name, phone number, and address) with our delivery riders solely to complete your delivery, and, where online payment is used, share payment details with Razorpay solely to process payments and refunds. We do not sell your personal information to third parties. We may disclose information where required by law, to protect our rights, or to investigate suspected fraud or abuse of the Platform.</p>
...
<p>Occasionally a specific item in your order may turn out to be unavailable or out of stock after the order is placed. Rather than cancelling the whole order, we'll remove just that item, tell you the reason on your order page, and adjust your total accordingly — for online payments, the difference is refunded automatically the same way as a full cancellation; the rest of your order is still packed and delivered as normal.</p>

<h2>7. Returns, Damaged, Incorrect, or Expired Items</h2>
<p>Most of what we sell is packaged and sealed by the manufacturer, and we're generally not able to accept a return simply because you've changed your mind once an order has been delivered and accepted. The exception is where something has genuinely gone wrong — the item received is materially different from what you ordered (not just a difference from the product photo, see our Terms &amp; Conditions on product images), arrived damaged or opened, arrived past its expiry date, or a loose/bulk item's weight is noticeably short. Please contact us with photos as soon as possible after delivery so we can make it right, whether that's a replacement or a refund, assessed case by case.</p>
...
<p>Shri Vinayak Family Shop offers quick, hyperlocal delivery direct from our own outlet in Siswa Bazar — we do not ship products by post or courier, and there are no tracking numbers or third-party delivery partners involved. This policy explains how that local delivery works.</p>

<h2>2. Delivery Area</h2>
<p>We currently deliver within a limited area around our Siswa Bazar outlet. If a delivery address falls outside our current delivery area, the Platform will let you know at checkout and the order cannot be placed to that address. Our delivery area may be adjusted from time to time as our team and coverage grow.</p>
...
<p>Your order page shows our best estimate for when your order will be delivered, typically around 20 minutes for nearby addresses. This is an estimate, not a guaranteed delivery window — actual timing can be affected by order volume, weather, traffic, or other circumstances beyond our control. Please keep your phone reachable and someone available at the delivery address around the estimated time.</p>

<h2>5. Order Packing &amp; Fulfilment</h2>
<p>Your order is picked and packed from our own stock once it's confirmed. Packaged items are dispatched exactly as received from the manufacturer; loose/bulk items (such as dal, rice, or other groceries sold by weight) are weighed out to the quantity you ordered at the time of packing.</p>
