    ...
    public function up(): void
    {
        ...
        DB::table('hero_banners')->insert([
            [
                ...
                'eyebrow' => 'No. 1 Grocery Store in Siswa Bazar',
                'title' => 'Celebrating Moments, Creating Sweet Memories',
                'subtitle' => 'Pure ingredients. Authentic taste. Delivered with care.',
            ...
            [
                ...
                'title' => 'Fresh Mithai, Straight From Siswa Bazar',
                'subtitle' => '100% pure ingredients. Trusted brands. No shortcuts, ever.',
            ...
            [
                ...
                'subtitle' => 'Sweets, snacks and more — all fresh, all sourced right.',
                'button_text' => 'Explore Our Sweets',
                'button_url' => '#bestsellers',
                'sort_order' => 2,
                'is_active' => true,
            ...
            [
                ...
                'title' => 'Every Product, Handpicked for You',
                'subtitle' => 'We restock before sunrise so your order is always fresh.',
